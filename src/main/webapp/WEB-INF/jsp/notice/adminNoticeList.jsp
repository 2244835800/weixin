...
<div style="width: 1220px; float: left;">
    <div class="div_opr">
        <div class="opr_div col_ora" onclick="createnotice('add','0');">创建公告</div>
    ...
    <div class="div_notice">
        <table class="tb_notice" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td style="width: 170px; text-align: left;" class="pdl5">公告标题</td>
                <td style="width: 300px; text-align: center;">公告内容</td>
            ...
            <tr>
                <td class="tac"><input type="checkbox" value="${list.noticeId}" name="check"></td>
                <td class="tal pdl5"><c:out value="${list.noticeTitle}"  escapeXml="true" /></td>
                <td class="tac tacid" title="${list.noticeMsg}">${list.noticeMsg}</td>
                
                <!-- 修改此处 -->
                 <td class="tac">${list.dateTime}</td>
                <!--  -->
                <td class="tac">
                    <div class="td_div_opr td_div_opr_org" onclick="shownotice(${list.noticeId});">查看</div>
                    <div class="td_div_opr td_div_opr_blu" onclick="createnotice('edit','${list.noticeId}');">编辑</div>
                    <div class="td_div_opr td_div_opr_gra" onclick="del('${list.noticeId}');">删除</div>
                </td>
            </tr>
           </c:forEach>
            </tbody>
...
<div id="delConfim" style="width: 400px; height: 200px; position: absolute; top: 200px; left: 400px; display: none; float: left; z-index: 2;">
    ...
    <div style="width: 400px; height: 150px; float: left; background-color: white; border: thin solid #bababa;">
        <div style="width: 400px; text-align: center;">
            ...
            <span style="font-size: 18px; margin-top:40px;">&nbsp;&nbsp;确定要删除所选公告吗？</span>
        </div>
...
<div id="checkNotice" style="width: 800px; height: auto; position: absolute; top: 50px; left: 200px; display: none; float: left; z-index: 3;">
    <div style="width: 800px; height: 50px; line-height: 50px; vertical-align: middle; background-color: #f5a22b; color: white; font-weight: bold;border: thin solid #f5a22b;">
        <span style="float: left;padding-left: 10px;">查看公告</span>
...
<div id="createNotice" style="width: 800px; height: auto; position: absolute; top: 50px; left: 200px; display: none; float: left; z-index: 3;">
    <div style="width: 800px; height: 50px; line-height: 50px; vertical-align: middle; background-color: #f5a22b; color: white; font-weight: bold;border: thin solid #f5a22b;">
        <span id="span_notice" style="float: left;padding-left: 10px;">创建公告</span>
    ...
    <div style="width: 800px; height: auto; float: left; background-color: white; border: thin solid #bababa;">
        ...
        <div style="width: 800px; height: 35px; line-height: 35px; vertical-align: middle; float: left; margin-top: 28px;">
            <div style="width: 100px; padding-left: 60px; color: black; font-size: 18px; font-weight: bold; float: left;" >公告标题</div>
            <div>
                <input class="easyui-textbox" style="width:500px; height:35px;" name="noticeTitle" id="title">
            </div>
        </div>
        <div style="width: 800px; height: 150px;float: left; margin-top: 28px;">
            <div style="width: 100px; padding-left: 60px; color: black; font-size: 18px; font-weight: bold; float: left; margin-top: 10px;">公告内容</div>
            <div>
                <input class="easyui-textbox" data-options="multiline:true" style="width:500px; height:150px;" name="noticeMsg" id="msg">
            </div>
        </div>
         <div style="width: 800px; height: 35px; line-height: 35px; vertical-align: middle; float: left; margin-top: 28px;">
            <div style="width: 100px; padding-left: 60px; color: black; font-size: 18px; font-weight: bold; float: left;">公告图片</div>
    ...
    $(document).ready(function () {
        ...
        $("#foot").paginate({
            ...
            onChange: function (page) {
            	...
            	window.location.href="getNoticeList?pageNow="+ page
...
function checkall(aa){
    	...
    	if(id==0){
    		var checks=document.getElementsByName("check");
      		...
      		if(result==""){
      			...
      			$("#deleteA").attr("href","deleteNotice?noticeId="+result);
    		...
    		$("#deleteA").attr("href","deleteNotice?noticeId="+id);
        $("#delConfim").css('display','block');
        }
    ...
    function uploadshow(){
        ...
        var nowtime = new Date();
         ...
         $("#showUptext").html("上传中..")
  		$.ajaxFileUpload({  
            type:"POST", 
            url:uploadurl+"/CourseImg/UpNoticeImg?name="+str, 
         ...
         $("#showUptext").html("上传成功")
             	 $("#showComments").val(uploadurl+"/Img/NoticeImg/"+str);
        		         ...
        		         url:"showNotice", 
        		          data:{id:id},
        		           ...
        		           success:function(data){ 
        		        	   console.log(data)
        		       $("#show_title").html(html_encode(data.noticeTitle));
        		       $("#show_time").html(data.dateTime);//暂存为时间
        		       $("#show_msg").html(html_encode(data.noticeMsg));
        		       if(data.comments==""){
    ...
    function createnotice(input,id) {
        	 ...
        	 $.ajax({  
		         ...
		         url:"showNotice", 
		          data:{id:id},
		           ...
		           async: false,
		           success:function(data){ 
		        	$("[name=noticeId]").val(id);
		      $("#title").textbox("setValue", data.noticeTitle);
		      $("#msg").textbox("setValue", data.noticeMsg);
