...
<table width="100%" border="0" bgcolor="#ffffff" cellpadding="0" cellspacing="0">
 ...
 <c:if test="${id==1}">政务公开</c:if>
  ...
  <form action="<%=request.getContextPath()%>/TipMsg/addTipMsgForm" method="post" id="form"  >
<input type="hidden" name="strTipPic1" id="strTipPic1">
<input type="hidden" name="strTipPic2" id="strTipPic2">
  <div style="margin-top:20px;" class="div_tip"><font class="font_tip">&nbsp;&nbsp;&nbsp;举报人：</font><input placeholder="请填写联系人姓名" class="input_tip" style="width:200px;" name="strPersonName"></div>  
  <div style="margin-top:20px;" class="div_tip"><font class="font_tip">联系方式：</font><input placeholder="请填写联系方式" style="width:200px;" class="input_tip" name="strPersonTelphone"></div>  
  <div style="margin-top:20px;height:180px;" class="div_tip"><font class="font_tip">详细描述：</font><textarea name="strTipDescription" placeholder="最多可输入500个字" rows="7" cols="22"    style="font-size:18px;margin-left:5px;outline: none;margin-top: 9px;border:0px;"></textarea></div>  
...
<li style="background-image:url(' <%=request.getContextPath()%>/img/uploadImg.png');border:0px;padding-left:0px;" id="upload"></li>
 ...
 <div style="margin-top:20px;" class="div_tip"><font class="font_tip">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址：</font><input placeholder="请填写具体地址" style="width:200px;" class="input_tip" name="comments"></div>  
  
  <div style="width: 300px;height: 40px;background-color:#3399FF;color:white;font-size: 28px;text-align: center;line-height: 40px;margin-left: 25px;margin-top: 20px;" onclick="check()">上报</div>
</form>
   </div>
