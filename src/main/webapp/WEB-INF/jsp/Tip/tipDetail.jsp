...
<table width="100%" border="0" bgcolor="#ffffff" cellpadding="0" cellspacing="0">
 ...
 <c:if test="${id==1}">政务公开</c:if>
    ...
    <div class="lb" >
    <span style="font-size: 18px;margin-top: 10px;">举报时间：</span><span style="font-size: 18px;">${adminTipMsg.commitTime}</span>
   <br> <br>
   <span style="font-size: 18px;margin-top: 10px;">举报地点：</span><span style="font-size: 18px;">${adminTipMsg.comments}</span>
    <br> <br>
    <span style="font-size: 18px;margin-top: 10px;">举报描述：</span><span style="font-size: 18px;">${adminTipMsg.strTipDescription}</span>
    <br> <br>
  <c:if test="${strTipPic1!=''}"><img src="${strTipPic1}" style="height: 300px;width: 300px;"></c:if> 
   <c:if test="${strTipPic2!=''}"><img src="${strTipPic2}" style="height: 300px;width: 300px;"></c:if> 
    <br>
