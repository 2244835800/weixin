...
<table width="100%" border="0" bgcolor="#ffffff" cellpadding="0" cellspacing="0">
 ...
 <c:if test="${id==1}">政务公开</c:if>
    ...
    <div class="lb" >
    <span style="font-size: 18px;margin-top: 10px;">新闻主题：</span><span style="font-size: 18px;">${msgNews.newsTitle}</span>
   <br> <br>
   <span style="font-size: 18px;margin-top: 10px;">新闻内容：</span><span style="font-size: 18px;">${msgNews.newsMsg}</span>
    <br> <br>
    <span style="font-size: 18px;margin-top: 10px;">发布时间：</span><span style="font-size: 18px;">${msgNews.dateTime}</span>
    <br> <br>
  <c:if test="${msgNews.comments!=''}"><img src="${msgNews.comments}" style="height: 300px;width: 300px;"></c:if> 
    <br>
    </div></div></td>
  </tr>
</tbody></table>
